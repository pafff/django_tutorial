...
def create_question(question_text, days, choices=[]):
    """
        ...
        Adds choices for the question from `choices` list
    """
    time = timezone.now() + datetime.timedelta(days=days)
    question = Question.objects.create(text=question_text,
                                       pub_date=time)
    for choice in choices:
        question.choice_set.create(text=choice)
    return question
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question_without_choices(self):
        """
        Questions with a pub_date in the past but without choices should not be
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_detail_view_with_a_past_question_without_choices(self):
        """
        The detail view of a question with a pub_date in the past but without
...
class QuestionResultsViewTests(TestCase):
    ...
    def test_detail_view_with_a_past_question_without_choices(self):
        """
        The result view of a question with a pub_date in the past but without
        choices should return a 404 not found.
        """
        past_question = create_question(question_text='Past Question.',
                                        days=-5)
